...
//import net.minecraft.nbt.TagUtils;
...
//    @Getter private final Set<INode2> rootNodes = new HashSet<>();
//
//    public UtilityTile() {
...
//     */
//    public boolean addRoot(INode2 node) {
...
//     */
//    private void onNodeSync(INode2 nodePacket, NetworkEvent.Context ctx) {
...
//     */
//    private INode2 findNode(INode2 toCheck) {
...
//     */
//    @Override public void read(BlockState state, TagUtils tag) {
...
//     * @param tag the tag to read from
//     */
//    private void readConnections(TagUtils tag) {
...
//     * @param tag the tag
//     */
//    @Override public TagUtils write(TagUtils tag) {
////        TagUtils nbt = super.write(tag);
...
//     * @param tag the tag
//     */
//    private TagUtils writeConnection(TagUtils tag) {
//        tag.putInt("conn_count", this.connections.size());
//        var index = new AtomicInteger(0);
//        this.connections.forEach(connection -> {
//            var conn = connection.write(new TagUtils());
...
//     */
//    @Override public TagUtils getUpdateTag() {
//        return this.write(new TagUtils());
//    }
//
//    /**
...
//         */
//        @Override public void read(TagUtils tag) {
